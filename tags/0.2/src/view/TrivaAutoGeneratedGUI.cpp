...
TrivaAutoGeneratedGUI::TrivaAutoGeneratedGUI( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_menu4 = new wxMenu();
	wxMenuItem* cameraForwardM;
	cameraForwardM = new wxMenuItem( m_menu4, wxID_ANY, wxString( wxT("Camera Forward") ) + wxT('\t') + wxT("ALT+8"), wxEmptyString, wxITEM_NORMAL );
	m_menu4->Append( cameraForwardM );
	
	wxMenuItem* cameraBackwardM;
	cameraBackwardM = new wxMenuItem( m_menu4, wxID_ANY, wxString( wxT("Camera Backward") ) + wxT('\t') + wxT("Alt+2"), wxEmptyString, wxITEM_NORMAL );
	m_menu4->Append( cameraBackwardM );
	
	wxMenuItem* cameraLeftM;
	cameraLeftM = new wxMenuItem( m_menu4, wxID_ANY, wxString( wxT("Camera Left") ) + wxT('\t') + wxT("Alt+4"), wxEmptyString, wxITEM_NORMAL );
	m_menu4->Append( cameraLeftM );
	
	wxMenuItem* cameraRightM;
	cameraRightM = new wxMenuItem( m_menu4, wxID_ANY, wxString( wxT("Camera Right") ) + wxT('\t') + wxT("Alt+6"), wxEmptyString, wxITEM_NORMAL );
	m_menu4->Append( cameraRightM );
	
	wxMenuItem* cameraUpM;
	cameraUpM = new wxMenuItem( m_menu4, wxID_ANY, wxString( wxT("Camera Up") ) + wxT('\t') + wxT("Alt+7"), wxEmptyString, wxITEM_NORMAL );
	m_menu4->Append( cameraUpM );
	
	wxMenuItem* cameraDownM;
	cameraDownM = new wxMenuItem( m_menu4, wxID_ANY, wxString( wxT("Camera Down") ) + wxT('\t') + wxT("Alt+1"), wxEmptyString, wxITEM_NORMAL );
	m_menu4->Append( cameraDownM );
	
	m_menubar2->Append( m_menu4, wxT("Navigation") );
	...
	this->Connect( cameraForwardM->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( TrivaAutoGeneratedGUI::cameraForward ) );
	this->Connect( cameraBackwardM->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( TrivaAutoGeneratedGUI::cameraBackward ) );
	this->Connect( cameraLeftM->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( TrivaAutoGeneratedGUI::cameraLeft ) );
	this->Connect( cameraRightM->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( TrivaAutoGeneratedGUI::cameraRight ) );
	this->Connect( cameraUpM->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( TrivaAutoGeneratedGUI::cameraUp ) );
	this->Connect( cameraDownM->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( TrivaAutoGeneratedGUI::cameraDown ) );
	...
	camCheckbox->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( TrivaAutoGeneratedGUI::cameraCheckbox ), NULL, this );
...
TrivaAutoGeneratedGUI::~TrivaAutoGeneratedGUI()
{
	...
	camCheckbox->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( TrivaAutoGeneratedGUI::cameraCheckbox ), NULL, this );
