...
TrivaAutoGeneratedGUI::TrivaAutoGeneratedGUI( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	cameraForwardM = new wxMenuItem( m_menu4, wxID_ANY, wxString( wxT("Camera Forward") ) , wxEmptyString, wxITEM_NORMAL );
	m_menu4->Append( cameraForwardM );
	
	wxMenuItem* cameraBackwardM;
	cameraBackwardM = new wxMenuItem( m_menu4, wxID_ANY, wxString( wxT("Camera Backward") ) , wxEmptyString, wxITEM_NORMAL );
	m_menu4->Append( cameraBackwardM );
	
	wxMenuItem* cameraLeftM;
	cameraLeftM = new wxMenuItem( m_menu4, wxID_ANY, wxString( wxT("Camera Left") ) , wxEmptyString, wxITEM_NORMAL );
	m_menu4->Append( cameraLeftM );
	
	wxMenuItem* cameraRightM;
	cameraRightM = new wxMenuItem( m_menu4, wxID_ANY, wxString( wxT("Camera Right") ) , wxEmptyString, wxITEM_NORMAL );
	m_menu4->Append( cameraRightM );
	
	wxMenuItem* cameraUpM;
	cameraUpM = new wxMenuItem( m_menu4, wxID_ANY, wxString( wxT("Camera Up") ) , wxEmptyString, wxITEM_NORMAL );
	m_menu4->Append( cameraUpM );
	
	wxMenuItem* cameraDownM;
	cameraDownM = new wxMenuItem( m_menu4, wxID_ANY, wxString( wxT("Camera Down") ) , wxEmptyString, wxITEM_NORMAL );
