...
private:
	NetworkTopology *viewController;
	Position *position;

public: 
	DrawManager (NetworkTopology *view);
	~DrawManager ();
...
// MOUSE CATEGORY
	NetworkTopologyWindow *trivaController;
private:
...
public:
	void setNetworkTopologyWindow (NetworkTopologyWindow *triva);
...
public:
	...
	void resourcesGraphDrawLinks (TrivaResourcesGraph *graph);
