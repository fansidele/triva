...
#define COLOUR_BINDING     1
	...
	#endif
#endif
MovableText::MovableText(const Ogre::String & name, const Ogre::UTFString &
caption, const Ogre::String & fontName, int charHeight, const Ogre::ColourValue & color)
: mpCam(NULL)
, mpWin(NULL)
, mpFont(NULL)
, mName(name)
...
bool MovableText::setFontName(const Ogre::String & fontName)
{
...
//    size_t charlen = mCaption.size();
    ...
    if (mSpaceWidth == 0)
        mSpaceWidth = (int)(mpFont->getGlyphAspectRatio('A') * mCharHeight * 2.0);

    // for calculation of AABB
    Ogre::Vector3 min = Ogre::Vector3 (0,0,0);
    Ogre::Vector3 max = Ogre::Vector3 (1,1,1), currPos;
