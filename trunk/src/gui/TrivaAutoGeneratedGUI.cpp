...
TrivaAutoGeneratedGUI::TrivaAutoGeneratedGUI( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	treemap_squarified = new wxMenuItem( m_menu5, wxID_ANY, wxString( wxT("Squarified Treemap") ) , wxEmptyString, wxITEM_NORMAL );
	m_menu5->Append( treemap_squarified );
	
	wxMenuItem* treemap_traditional;
	treemap_traditional = new wxMenuItem( m_menu5, wxID_ANY, wxString( wxT("Original Treemap") ) , wxEmptyString, wxITEM_NORMAL );
	m_menu5->Append( treemap_traditional );
	
	wxMenuItem* Graph;
	Graph = new wxMenuItem( m_menu5, wxID_ANY, wxString( wxT("Graph of Resources") ) , wxEmptyString, wxITEM_NORMAL );
	m_menu5->Append( Graph );
	Graph->Enable( false );
	...
	this->Connect( treemap_traditional->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( TrivaAutoGeneratedGUI::originalTreemap ) );
