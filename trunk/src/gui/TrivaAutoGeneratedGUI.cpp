...
{
	this->SetSizeHints( wxSize( 409,50 ), wxSize( 409,50 ) );
	...
	stateName = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 300,-1 ), wxTE_READONLY );
	stateName->SetMaxLength( 800 ); 
	fgSizer2->Add( stateName, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 5 );
	
	colorPicker = new wxColourPickerCtrl( this, wxID_ANY, *wxBLACK, wxDefaultPosition, wxDefaultSize, wxCLRP_DEFAULT_STYLE );
	fgSizer2->Add( colorPicker, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL|wxALL, 5 );
	
	this->SetSizer( fgSizer2 );
	this->Layout();
	
	// Connect Events
	colorPicker->Connect( wxEVT_COMMAND_COLOURPICKER_CHANGED, wxColourPickerEventHandler( TrivaColorWindow::colorChanged ), NULL, this );
}

TrivaColorWindow::~TrivaColorWindow()
{
	// Disconnect Events
	colorPicker->Disconnect( wxEVT_COMMAND_COLOURPICKER_CHANGED, wxColourPickerEventHandler( TrivaColorWindow::colorChanged ), NULL, this );
}
