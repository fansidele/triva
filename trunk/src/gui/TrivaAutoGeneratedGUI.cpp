...
TrivaAutoGeneratedGUI::TrivaAutoGeneratedGUI( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	this->Connect( m_menuItem7->GetId(), wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( TrivaAutoGeneratedGUI::colourWindow ) );
...
TrivaAutoGeneratedGUI::~TrivaAutoGeneratedGUI()
{
	...
	this->Disconnect( wxID_ANY, wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( TrivaAutoGeneratedGUI::colourWindow ) );
...
TrivaColorWindow::TrivaColorWindow( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	bSizer7->Add( m_colourPicker1, 0, wxALL, 5 );
