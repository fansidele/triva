...
class TrivaAutoGeneratedGUI : public wxFrame 
{
	...
	protected:
		...
		wxMenu* navigation;
		wxMenu* m_menu5;
		wxMenuItem* treemap_squarified;
		wxMenuItem* treemap_original;
		wxMenuItem* graph_resources;
		wxMenuItem* graph_application;
		wxMenu* m_menu6;
		wxToolBar* toolbar;
		wxButton* playButton;
		...
		virtual void squarifiedTreemap( wxCommandEvent& event ){ event.Skip(); }
		virtual void originalTreemap( wxCommandEvent& event ){ event.Skip(); }
		virtual void resourcesGraph( wxCommandEvent& event ){ event.Skip(); }
		virtual void applicationGraph( wxCommandEvent& event ){ event.Skip(); }
