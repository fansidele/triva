...
class TrivaColorWindow : public wxFrame 
{
	...
	public:
		TrivaColorWindow( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("TrivaColorWindow"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 409,50 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
		~TrivaColorWindow();
