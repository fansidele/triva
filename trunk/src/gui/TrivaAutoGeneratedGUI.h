...
class TrivaAutoGeneratedGUI : public wxFrame 
{
	...
	protected:
		...
		virtual void openColorWindow( wxCommandEvent& event ){ event.Skip(); }
...
///////////////////////////////////////////////////////////////////////////////
/// Class TrivaColorWindow
///////////////////////////////////////////////////////////////////////////////
class TrivaColorWindow : public wxFrame 
{
	private:
	
	protected:
		wxComboBox* stateCombo;
		wxColourPickerCtrl* m_colourPicker1;
	
	public:
		TrivaColorWindow( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("TrivaColorWindow"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 444,109 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
		~TrivaColorWindow();
