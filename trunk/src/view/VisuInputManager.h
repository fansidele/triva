#ifndef _VISU_INPUT_MANAGER__
#define _VISU_INPUT_MANAGER__
...
public:
	...
	static VisuInputManager* getSingletonPtr( void );
...
private:
	VisuInputManager( void );
	VisuInputManager( const VisuInputManager& ) { }
	VisuInputManager & operator = ( const VisuInputManager& );
	...
	static VisuInputManager *mVisuInputManager;
};
#endif
